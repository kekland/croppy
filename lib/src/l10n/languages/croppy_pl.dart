...
class CroppyLocalizationsPl extends CroppyLocalizations {
  ...
  @override
  String get cupertinoFreeformAspectRatioLabel => 'DOWOLNE';

  @override
  String get cupertinoOriginalAspectRatioLabel => 'ORYGINALNE';
  ...
  @override
  String get materialFreeformAspectRatioLabel => 'Dowolne';

  @override
  String materialGetFlipLabel(LocalizationDirection direction) =>
      'Przerzuć ${direction == LocalizationDirection.vertical ? 'pionowo' : 'poziomo'}';

  @override
  String get materialOriginalAspectRatioLabel => 'Oryginalne';
